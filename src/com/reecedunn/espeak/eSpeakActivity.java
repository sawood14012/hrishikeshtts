...
public class eSpeakActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.ssml).setVisibility(View.GONE);
    ...
    private void initializeEngine() {
        ...
        mTts = new TextToSpeech(this, mInitListener,"com.reecedunn.espeak");
        Log.e(mTts.getEngines().toString(),"j");
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            android.speech.tts.Voice voice = new Voice("en-us-x-sfg#male_1-local",new Locale("en","UK"),400,200,true,a);
            mTts.setVoice(mTts.getDefaultVoice());
           // Log.e(mTts.getVoices().toString(),"j");
        }
    ...
    private void onInitialized(int status) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mTts.speak("Hello enter any text to speak", TextToSpeech.QUEUE_ADD, null, null);
        } else {
            mTts.speak("Hello enter any text to speak", TextToSpeech.QUEUE_ADD, null);
        }
    }
